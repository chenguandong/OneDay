...
- (void)paste:(id)sender {
    ...
    if (!atr && _allowsPasteImage) {
        ...
        if (img && img.size.width > 1 && img.size.height > 1) {
           ...
           // img.size.width>kScreenWidth?img.size.width/kScreenWidth*img.size.width:img.size.width
            
           // img.size.width>kScreenWidth?kScreenWidth/img.size.width*img.size.width:img.size.width
            
           // img.size.width>kHY_SCREEN_WIDTH?kHY_SCREEN_WIDTH/img.size.width*kHY_SCREEN_WIDTH:img.size.width
            
//            NSMutableAttributedString *attText = [NSAttributedString attachmentStringWithContent:content contentMode:UIViewContentModeScaleAspectFill width:img.size.width ascent:img.size.height descent:0];
            
             NSMutableAttributedString *attText = [NSAttributedString attachmentStringWithContent:content contentMode:UIViewContentModeScaleToFill width:img.size.width>=kHY_SCREEN_WIDTH?kHY_SCREEN_WIDTH-20:img.size.width ascent:img.size.width>=kHY_SCREEN_WIDTH?(kHY_SCREEN_WIDTH-20)/img.size.width*img.size.height:img.size.height descent:0];
